...
/// (twodog, GodotSharp, GodotPlugins, ...) load here, giving the instance its
/// own copy of every managed static - which is the entire isolation model.
...
internal sealed class InstanceAlc : AssemblyLoadContext
{
    ...
    internal static readonly string[] NeverShared =
        ["twodog", "GodotSharp", "GodotSharpEditor", "GodotPlugins", "twodog.hosting.runtime"];
    ...
    protected override Assembly? Load(AssemblyName assemblyName)
    {
        ...
        // Fail closed for the engine stack: unresolved means misconfiguration,
