...
public sealed record InstanceOptions
{
    ...
    /// assembly referencing the twodog engine stack). Set implicitly by Start&lt;T&gt;.</summary>
    ...
    /// <summary>Native variant when <see cref="NativeSourcePath"/> is not set: 'release',
    /// 'debug', or 'editor'. Null follows the consuming app's TwoDogVariant assembly
    /// metadata (the same discovery twodog's own loader uses).</summary>
