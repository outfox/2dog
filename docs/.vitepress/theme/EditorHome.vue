...
const features = [
  {
    ...
    tint: '2d',
    name: 'C# on the Web',
    detail: 'Export HTML5 and WASM. No more waiting — Godot is home!',
    link: '/convert',
  ...
  },
  {
    ...
    detail: 'A companion, not a replacement. Keep editing in stock Godot.',
    link: '/project-layout',
  ...
  },
  {
    ...
    detail: 'Load scenes and resources in xUnit — headless, in your IDE or CI.',
    link: '/testing',
  ...
  },
  {
    ...
    detail: 'Your process starts Godot, drives each frame, stops the engine.',
    link: '/concepts',
