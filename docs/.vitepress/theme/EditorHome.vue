...
const features = [
  {
    ...
    tint: '2d',
    name: 'C# on the Web',
    detail: 'Export C# Games to HTML5 and WASM. No more waiting for Godot!',
    link: '/convert',
  ...
  },
  {
    ...
    detail: 'A companion, not a replacement. 100% compatible, go back and forth.',
    link: '/project-layout',
  ...
  },
  {
    ...
    detail: 'Test scenes, scripts, and resources in xUnit. Use IDE test runners or CI.',
    link: '/testing',
  ...
  },
  {
    ...
    detail: 'Your process starts Godot, pumps each frame, and drives the engine.',
    link: '/concepts',
