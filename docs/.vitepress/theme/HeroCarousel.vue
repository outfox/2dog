...
const slogans: Slogan[] = [
  ...
  { name: "Who's a good engine?", text: "Godot is! Yes it is!" },
  { name: "Sit, Godot!", text: "Good engine. Now render." },
  { name: "Teaching old Godot...", text: "...new tricks" },
  { name: "Godot? More like...", text: "Go-do-what-you-want!" },
  { name: "Every Robot deserves...", text: "...a good .NET home" },
  { name: "Fetch the scene tree!", text: "Good Robot!" },
  { name: "No more waiting...", text: "...for Godot" },
  { name: "Your Godot...", text: "...your rules" },
  { name: "Godot heel!", text: "Godot speak! Godot run!" },
  { name: "Roll over, Godot!", text: "Time to run .NET side up" },
  { name: "Unit tests?", text: "A walk in the park!" },
  { name: "MIT Licensed Service Dog", text: "Free to good home!" },
