...
export default defineConfig({
  ...
  head: [
    ...
    ['meta', { name: "twitter:title", content: "2dog – Godot in .NET" }],
    ...
    ['meta', { name: "twitter:description", content: "Embed Godot Engine in your .NET applications. Full engine control, xUnit testing, and CI/CD support." }],
    ['meta', { property: "og:type", content: "website" }],
    ['meta', { property: "og:url", content: "https://2dog.dev" }],
    ['meta', { property: "og:title", content: "2dog – Godot in .NET" }],
    ['meta', { property: "og:description", content: "Embed Godot Engine in your .NET applications. Full engine control, xUnit testing, and CI/CD support." }],
