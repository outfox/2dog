...
internal static class BuildSignatures
{
    ...
    [
        ...
        new("build.no-import-capability", Rx(@"needs a resource import, but no import capability was found"),
        ...
        new("build.import-required", Rx(@"import required \(TwoDogRequireImport=true\) but no import capability"),
            "the build requires an import (TwoDogRequireImport=true) and has no import capability",
            "dotnet restore --force (restores the editor and tools packages), or set GODOT_EDITOR / <GodotEditor>"),
