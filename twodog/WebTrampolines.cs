...
internal static class WebTrampolines
{
    ...
    [UnmanagedFunctionPointer(CallingConvention.Winapi)]
    internal delegate ulong object_get_instance_id_sig(IntPtr _0);
    [UnmanagedFunctionPointer(CallingConvention.Winapi)]
    internal delegate void object_method_bind_ptrcall_sig(IntPtr _0, IntPtr _1, IntPtr _2, IntPtr _3);
    [UnmanagedFunctionPointer(CallingConvention.Winapi)]
    internal delegate void string_name_new_with_latin1_chars_sig(IntPtr _0, IntPtr _1, byte _2);
    [UnmanagedFunctionPointer(CallingConvention.Winapi)]
    internal delegate IntPtr get_proc_address_sig(IntPtr _0);
}
